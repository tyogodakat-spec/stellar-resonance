...
const SKILL_DESC = {
  ...
  wonderofyou: {
    basic: [
      ...
      "Ganha <b>+1 Ponto de Habilidade</b>.",
      "✦ <b>Talento — A Calamidade Não Escolhe:</b> cada acerto CRÍTICO aplica <b>+8% de Vulnerabilidade</b> a <b>todos os inimigos</b> por 2 turnos (acumula até <b>+24%</b>). Se um inimigo morrer sob efeito de qualquer debuff dela, Wonder of You recupera <b>15 de Energia</b> imediatamente.",
      "<b>[A2 · Marca da Calamidade]</b> Inimigos com qualquer debuff exclusivo recebem <b>+12% de dano de todas as fontes</b> enquanto o debuff durar.",
      "<b>[A4 · Convite ao Vazio]</b> Ao final de cada turno em que 2+ debuffs dela estiverem ativos no alvo, recupera <b>+10 de Energia</b> extra.",
      "<b>[A6 · A Calamidade Absoluta]</b> Quando qualquer debuff expira naturalmente, dispara explosão residual de <b>120% do ATK</b> no alvo.",
      "<b>[E1 · O Convite Aceito]</b> Entra em batalha com o estágio inicial da Calamidade ativo em todos os inimigos.",
    ],
    skill: [
      "Custo: <b>1 Ponto de Habilidade</b>.",
      "Calamidade Inevitável: causa <b>210% de ATK</b> em Dano de Caos a <b>todos os inimigos</b> (área).",
      "Aplica simultaneamente <b>4 debuffs exclusivos</b> por <b>3 turnos</b> em todos os alvos:",
      "• <b>Miss da Calamidade:</b> +20% de chance de errar os ataques.",
      "• <b>Vulnerabilidade:</b> +18% de dano recebido de todas as fontes.",
      "• <b>Atraso Fatal:</b> −12% de VEL.",
      "• <b>Colapso de Atributos:</b> −15% de DEF.",
      "Concede <b>Bênção da Calamidade</b> ao time inteiro: <b>+18% de Dano Bônus</b> por 3 turnos.",
      "<b>[A2 · Marca da Calamidade]</b> Cada debuff ativo concede ao time <b>+12% de dano</b> contra o alvo.",
      "<b>[E2 · A Confiança Cega]</b> Duração dos debuffs sobe para <b>4 turnos</b>. Cada debuff ativo concede <b>+4% de dano</b> a ela (máx <b>+16%</b>).",
      "<b>[E3 · A Traição Certa]</b> Nível da Habilidade +2 — dano e potência dos debuffs aumentados.",
      "<b>[Arma · Calamidade]</b> Ao usar a Habilidade, ignora <b>20% da DEF</b> de todos os inimigos por 2 turnos.",
    ],
    ult: [
      "Custo: <b>130 de Energia</b>.",
      "Lei da Calamidade Absoluta: causa <b>400% de ATK</b> em Dano de Caos a <b>todos os inimigos</b> (área).",
      "Renova e reaplica os <b>4 debuffs exclusivos</b> por <b>4 turnos</b> em todos os alvos:",
      "• <b>Miss da Calamidade</b> (+20% de erros) · <b>Vulnerabilidade</b> (+18%) · <b>Atraso Fatal</b> (−12% VEL) · <b>Colapso de Atributos</b> (−15% DEF).",
      "<b>[A6 · A Calamidade Absoluta]</b> Quando qualquer debuff expira naturalmente, dispara explosão residual de <b>120% do ATK</b> no alvo.",
      "<b>[E4 · O Abismo Pessoal]</b> Ao matar inimigo com debuff ativo, ganha <b>+15% de ATK</b> permanentemente (acumula até <b>3×</b>).",
      "<b>[E5 · Ponto de Quebra]</b> Nível da Ultimate +2 e custo de Energia <b>−15%</b>.",
      "<b>[E6 · O Último Pacto]</b> Todos os 4 debuffs em <b>dobro de intensidade</b> por <b>4 turnos</b>. Com 3+ debuffs simultâneos: ignora <b>30% da DEF</b> de todos os alvos.",
    ],
  },
  athena: {
    basic: [
      "Causa <b>90% de ATK</b> em Dano Holy no inimigo principal — Lança de Luz.",
      "Ganha <b>+1 Ponto de Habilidade</b> e <b>+10 de Energia</b>.",
      "✦ <b>Talento — Eco da Justiça:</b> ao curar um aliado com a Habilidade, todos os outros aliados recebem automaticamente <b>50% daquele valor de cura</b>. Se algum aliado estiver abaixo de <b>50% de HP</b>, o eco de cura nele é <b>dobrado</b>.",
      "━━ <b>Modo Aprimorado · Lança de Luz (após a Ultimate):</b> ━━",
      "O Ataque Básico transforma-se: causa <b>Dano Holy em área</b> e reduz a <b>Resistência Holy dos inimigos em 15%</b> por 2 turnos.",
      "<b>[Traço II · Luz Consagrada]</b> No Modo Aprimorado, o Ataque Básico também <b>cura o time em 15% do dano causado</b>.",
      "<b>[C6 · Sétima Casa]</b> O Modo Aprimorado dura <b>3 turnos</b> em vez de 2 e permite escolher 2 aliadas das Casas.",
    ],
    skill: [
      "Custo: <b>1 Ponto de Habilidade</b>.",
      "Bênção das Sete Casas: cura o aliado com <b>menor HP</b> em <b>130% do ATK</b>.",
      "Aplica <b>Armadura de Luz</b> no alvo curado: <b>−15% de dano recebido</b> por <b>2 turnos</b>.",
      "✦ <b>Eco da Justiça</b> (Talento): todos os outros aliados recebem <b>50% daquele valor de cura</b>. Se algum estiver abaixo de 50% de HP, o eco nele é <b>dobrado (100%)</b>.",
      "<b>[Traço I · Guardiã das Casas]</b> Ao curar aliado com HP cheio, o excedente vira um <b>escudo de 50% do valor</b> da cura por 2 turnos.",
      "<b>[C2 · Segunda Casa: Touro]</b> Cura <b>+15% a mais</b> e a Armadura de Luz dura <b>+1 turno</b> (3 turnos total).",
      "<b>[C4 · Quarta Casa: Câncer]</b> Ao curar aliado com HP < 50%, ele recebe imediatamente <b>+15 de Energia</b>.",
      "<b>[Arma · Cetro da Autoridade Celestial]</b> Ao curar um aliado, ele recebe <b>+10% de Dano Bônus</b> por 2 turnos.",
    ],
    ult: [
      "Custo: <b>140 de Energia</b>.",
      "Julgamento do Olimpo: invoca as Sete Casas — todo o time recebe por <b>3 turnos</b>:",
      "• <b>+30% de VEL</b> · <b>+30% de DEF</b> · <b>+20% de Taxa de CRIT</b>.",
      "Athena entra no <b>Modo Aprimorado (Lança de Luz)</b> por <b>2 turnos</b>.",
      "<b>[Traço III · Julgamento das Sete Casas]</b> Concede <b>+1 Ponto de Ação (turno extra imediato)</b> à aliada escolhida entre as Casas (1× por combate).",
      "<b>[C1 · Primeira Casa: Áries]</b> A aliada escolhida recebe também <b>+20% de Taxa de CRIT</b> por 2 turnos.",
      "<b>[C5 · Quinta Casa: Leão]</b> Nível da Ultimate +2 e custo de Energia <b>−15%</b>.",
      "<b>[C6 · Sétima Casa: Escorpião ao Peixes]</b> Modo Aprimorado dura <b>3 turnos</b> e permite escolher <b>2 aliadas das Casas</b> para receberem a bênção completa.",
    ],
  },
